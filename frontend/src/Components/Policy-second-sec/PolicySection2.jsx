        ...
        <div className="details">
          <ol>
            ...
            <ul>
              ...
              <li>We offer shipping all over India.</li>
              <li>
                ⁠Orders take 3-10 working days to reach anywhere in India. In some cases, it might take more time, due to local restrictions and during special sale periods
              </li>
            </ul>
