    ...
    <div className='workers-section'>
      <div className='workers-content-container'>
        <div className="workers-right order-2">
          <p>We also did our best to <span>procure from our farmers.</span> Instead of working with middlemen, we buy directly from farmers,<span> ensuring they receive fair income.</span> This helps support their livelihoods and strengthens our community.</p>
        </div>
